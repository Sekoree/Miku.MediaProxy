...
namespace NNDD.Entities
{
    public class VideoAPIData
    {
        ...
        public Meta MetaField { get; set; }

        [JsonPropertyName("data")]
        public Data DataField { get; set; }
        ...
        public partial class Session
        {
            ...
            public List<ContentSrcIdSet> ContentSrcIdSets { get; set; }
            ...
            public double? PlaySeekTime { get; set; }
        ...
        public partial class ContentSrcIdSet
        {
            ...
            public List<ContentSrcId> ContentSrcIds { get; set; }
        ...
        public partial class SrcIdToMux
        {
            ...
            public List<string> VideoSrcIds { get; set; }

            [JsonPropertyName("audio_src_ids")]
            public List<string> AudioSrcIds { get; set; }
        }
        ...
        public partial class RuntimeInfo
        {
            ...
            public List<object> ExecutionHistory { get; set; }

            [JsonPropertyName("thumbnailer_state")]
            public List<object> ThumbnailerState { get; set; }
        }
