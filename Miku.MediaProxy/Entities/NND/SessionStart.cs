...
namespace NNDD.Entities
{
    ...
    {
        public SessionJson(WatchData data, string audio, string video)
        {
        ...
        public partial class HttpParametersParameters
        {
            ...
            public HttpOutputDownloadParameters HttpOutputDownloadParameters { get; set; } = new HttpOutputDownloadParameters();
        }
